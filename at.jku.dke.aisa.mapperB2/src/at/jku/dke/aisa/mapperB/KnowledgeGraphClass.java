...
public class KnowledgeGraphClass {
	...
	private String endPartOfPrologRule;
	...
	public KnowledgeGraphClass(Graph shaclGraph, Shape rootShape, boolean isSuperClass, String graphName) {
		...
		createProperties();
		generateSPARQLQuery();
		generateEndPartOfPrologRule();
	}
	
	/**
	 * Generates the end part of the Prolog rule.
	 * 
	 * e.g.: ,row(Graph,City,Name,NameUnit,AnnotationConcat),[]), convert(AnnotationConcat,AnnotationList).
	 * 
	 */
	private void generateEndPartOfPrologRule() {
		String lists = "";
	...
	public String getEndPartOfPrologRule() {
		return this.endPartOfPrologRule;
	}
}
